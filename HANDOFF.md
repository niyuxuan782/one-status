...
Generated: 2026-08-09T17:53:38.240Z
...
- Install One Status 0.7.0 on a second physical device.
- Login with the recovery key and verify encrypted Status decryption.
- Open the latest published Handoff at its exact Git commit.
- Confirm Codex or Claude Code restores the v0.7 context and reports the local tool inventory.
...
- Branch: main
- Commit: 1d04e0a9a74c2db02020cabe7e0b6962015c9d7e
- Dirty: no
- Tests: not run
